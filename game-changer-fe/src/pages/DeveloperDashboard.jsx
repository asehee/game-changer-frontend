      ...
      <div className="min-h-screen relative">
        ...
        <div className="relative z-10 container mx-auto px-6 py-12">
          <div className="max-w-2xl mx-auto">
            ...
            {/* Activation Card */}
            <div className="backdrop-blur-xl bg-white/10 rounded-3xl p-10 text-center shadow-xl border border-white/20 mb-8">
              <div className="mb-8">
                ...
                <h3 className="text-2xl font-bold text-white mb-3">개발자로 시작하세요</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <div className="backdrop-blur-xl bg-white/10 rounded-2xl p-6 text-center shadow-lg border border-white/20">
                ...
                <h4 className="font-bold text-white mb-2">수익 창출</h4>
                <p className="text-sm text-white/60">시간당 과금으로 안정적인 수익 구조</p>
              </div>
              ...
              <div className="backdrop-blur-xl bg-white/10 rounded-2xl p-6 text-center shadow-lg border border-white/20">
                ...
                <h4 className="font-bold text-white mb-2">상세 분석</h4>
                <p className="text-sm text-white/60">플레이어 통계와 수익 분석 도구</p>
              </div>
              ...
              <div className="backdrop-blur-xl bg-white/10 rounded-2xl p-6 text-center shadow-lg border border-white/20">
                ...
                <h4 className="font-bold text-white mb-2">글로벌 유저</h4>
                <p className="text-sm text-white/60">전 세계 플레이어들과 연결</p>
              </div>
            </div>
            ...
            <div className="text-center">
              <Link 
                to="/" 
                className="inline-flex items-center gap-2 text-blue-400 hover:text-blue-300 font-medium transition-colors duration-200 hover:scale-105"
              >
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="backdrop-blur-xl bg-white/10 rounded-3xl p-10 text-center shadow-xl border border-white/20 mb-8">
              <div className="mb-8">
                ...
                <h3 className="text-2xl font-bold text-white mb-3">첫 게임을 업로드하세요</h3>
                <p className="text-white/60 leading-relaxed mb-6">
      ...
      <div className="relative z-10 container mx-auto px-6 py-12">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            {/* Wallet Info */}
            <div className="backdrop-blur-xl bg-white/10 rounded-2xl p-6 inline-block shadow-lg border border-white/20">
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    {copied ? (
                      ...
                      <Copy className="w-4 h-4 text-white/60 hover:text-white/60" />
                    )}
                  </button>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            <div className="backdrop-blur-xl bg-white/10 rounded-3xl p-8 text-center shadow-xl border border-white/20">
              ...
              <p className="text-white/60 font-medium">총 수익</p>
            ...
            <div className="backdrop-blur-xl bg-white/10 rounded-3xl p-8 text-center shadow-xl border border-white/20">
              ...
              <p className="text-white/60 font-medium">게임 수</p>
            ...
            <div className="backdrop-blur-xl bg-white/10 rounded-3xl p-8 text-center shadow-xl border border-white/20">
              ...
              <p className="text-white/60 font-medium">총 플레이어</p>
            </div>
            ...
            <div className="backdrop-blur-xl bg-white/10 rounded-3xl p-8 text-center shadow-xl border border-white/20">
              ...
              <p className="text-white/60 font-medium">총 플레이 시간</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            {/* My Games */}
            <div className="backdrop-blur-xl bg-white/10 rounded-3xl p-8 shadow-xl border border-white/20 h-96">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center shadow-lg shadow-blue-500/25">
                  <GamepadIcon className="w-6 h-6 text-white" />
                </div>
                <h2 className="text-2xl font-bold text-white">내 게임</h2>
              </div>
              
              <div className="space-y-4 max-h-64 overflow-y-auto">
                {dashboardData?.games?.length > 0 ? (
                  dashboardData.games.map((game) => (
                    <div key={game.id} className="bg-white/60 rounded-2xl p-4 shadow-lg border border-white/20">
                      <div className="flex justify-between items-start mb-3">
                        <h3 className="font-bold text-white">{game.title}</h3>
                        <span className={`px-3 py-1 rounded-full text-xs font-medium ${
                          game.status === 'active' 
                            ? 'bg-green-100 text-green-700' 
                            : 'bg-gray-100 text-white/60'
                        }`}>
                          {game.status}
                        </span>
                      </div>
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        <div>
                          <div className="text-white/60">플레이어</div>
                          <div className="font-bold text-white">{game.playerCount}</div>
                        </div>
                        <div>
                          <div className="text-white/60">평점</div>
                          <div className="font-bold text-white">⭐ {game.rating}</div>
                        </div>
                      </div>
                    </div>
                  ))
                  ...
                  <div className="flex flex-col items-center justify-center h-40 text-center">
                    <GamepadIcon className="w-12 h-12 text-white/60 mb-3" />
                    <p className="text-white/40">아직 업로드된 게임이 없습니다</p>
                    <button
                      onClick={startUploading}
                      className="mt-3 text-blue-400 hover:text-blue-300 font-medium text-sm hover:scale-105 transition-all duration-200"
                    >
                      첫 게임 업로드하기
                    </button>
                  </div>
            ...
            <div className="backdrop-blur-xl bg-white/10 rounded-3xl p-8 shadow-xl border border-white/20 h-96">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-white">최근 세션</h2>
              </div>
              
              <div className="space-y-4 max-h-64 overflow-y-auto">
                {dashboardData?.recentSessions?.length > 0 ? (
                  dashboardData.recentSessions.map((session) => (
                    <div key={session.id} className="bg-white/60 rounded-2xl p-4 shadow-lg border border-white/20">
                      <div className="flex justify-between items-start mb-3">
                        <div>
                          <h4 className="font-bold text-white">{session.gameTitle}</h4>
                          <p className="text-sm text-white/60">{session.userWallet?.slice(0, 10)}...</p>
                        </div>
                        <span className={`px-3 py-1 rounded-full text-xs font-medium ${
                      ...
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        <div>
                          <div className="text-white/60">플레이 시간</div>
                          <div className="font-bold text-white">{formatTime(session.activePlayTime)}</div>
                        </div>
                        <div>
                          <div className="text-white/60">수익</div>
                          <div className="font-bold text-white">{formatCurrency(session.totalCost)}</div>
                        </div>
                      </div>
                    </div>
                  ))
                  ...
                  <div className="flex flex-col items-center justify-center h-40 text-center">
                    <Clock className="w-12 h-12 text-white/60 mb-3" />
                    <p className="text-white/40">아직 세션이 없습니다</p>
                  </div>
                )}
              </div>
            </div>
